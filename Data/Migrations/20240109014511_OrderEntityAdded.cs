    ...
    public partial class OrderEntityAdded : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    BuyerId = table.Column<string>(type: "TEXT", nullable: false),
                    ShippingAddress_MyProperty = table.Column<string>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "1", "e3e96a89-22a5-4981-afa8-5b75560499f7", "Member", "MEMBER" });

            migrationBuilder.InsertData(
                table: "IdentityRole",
                columns: new[] { "Id", "ConcurrencyStamp", "Name", "NormalizedName" },
                values: new object[] { "2", "a69859a7-7447-4299-8e56-fa6b57a2d50c", "Admin", "ADMIN" });
